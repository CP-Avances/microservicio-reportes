...
@RestController
@RequestMapping("/api/reporte/modalidad-laboral")
    ...
    public ResponseEntity<byte[]> generarReporte(@RequestBody ReporteModalidadLaboralRequest request) {
        try {
            ...
            return ResponseEntity.ok()
                    ...
                    .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=ModalidadLaboral.pdf")
    ...
    public ResponseEntity<byte[]> generarReporteXLSX(@RequestBody ReporteModalidadLaboralRequest request) {
        try {
            ...
            return ResponseEntity.ok()
                    ...
                    .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=ModalidadLaboral.xlsx")
                    .header(HttpHeaders.CACHE_CONTROL, "no-store")
                    .header(HttpHeaders.PRAGMA, "no-cache")
                    .header(HttpHeaders.EXPIRES, "0")
                    .body(bin);
    ...
    public ResponseEntity<byte[]> generarReporteCSV(@RequestBody ReporteModalidadLaboralRequest request) {
        try {
            ...
            return ResponseEntity.ok()
                    ...
                    .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=ModalidadLaboral.csv")
                    .header(HttpHeaders.CACHE_CONTROL, "no-store")
                    .header(HttpHeaders.PRAGMA, "no-cache")
                    .header(HttpHeaders.EXPIRES, "0")
                    .body(bin);
    ...
    public ResponseEntity<byte[]> generarReporteXML(@RequestBody ReporteModalidadLaboralRequest request) {
        try {
            ...
            return ResponseEntity.ok()
                    ...
                    .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=ModalidadLaboral.xml")
                    .header(HttpHeaders.CACHE_CONTROL, "no-store")
                    .header(HttpHeaders.PRAGMA, "no-cache")
                    .header(HttpHeaders.EXPIRES, "0")
                    .body(bin);

...
import com.casapazmino.microservicio_reportes.model.NivelTituloDTO;
import com.casapazmino.microservicio_reportes.model.ReporteNivelesTitulosRequest;
...
public class ReporteNivelTituloService {
    ...
    public byte[] generarReporteNivelTituloPDF(ReporteNivelesTitulosRequest request) {
        try {
            ...
            // Título
            Paragraph titulo = new Paragraph("LISTA DE NIVELES DE TÍTULOS PROFESIONALES", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 12));
            ...
            // Filas
            List<NivelTituloDTO> lista = request.getNivelesTitulos(); // ← Corrección aquí

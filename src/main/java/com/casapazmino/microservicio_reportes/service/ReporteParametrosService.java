            ...
            for (ParametroDTO parametro : request.getParametros()) {
                ...
                if (parametro.getDetalles() != null && !parametro.getDetalles().isEmpty()) {
                    ...
                    for (DetalleParametroDTO d : parametro.getDetalles()) {
                        tabla.addCell(ReporteUtil.crearCelda(String.valueOf(d.getId()), ReporteUtil.fuenteTablaData(),
                                Color.WHITE));
                        tabla.addCell(
                                ReporteUtil.crearCelda(d.getDescripcion(), ReporteUtil.fuenteTablaData(), Color.WHITE));
                        tabla.addCell(
                                ReporteUtil.crearCelda(d.getObservacion(), ReporteUtil.fuenteTablaData(), Color.WHITE));
                    }
                    document.add(tabla);
                }
            }

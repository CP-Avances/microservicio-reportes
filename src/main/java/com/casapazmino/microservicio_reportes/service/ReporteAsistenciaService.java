...
public class ReporteAsistenciaService {
        ...
        public byte[] generarReporteResumenAsistenciaXLSX(ReporteAsistenciaRequest request) {
                try (XSSFWorkbook libro = new XSSFWorkbook();
                        ...
                        UtilExcel.establecerTexto(hoja, 0, 1, UtilExcel.aMayusculasSeguras(request.getEmpresa()),
                                        estiloTitulo);
                        ...
                        if (request.getGrupos() != null) {
                                for (GrupoAsistenciaDTO grupo : request.getGrupos()) {
                                        ...
                                        for (EmpleadoAsistenciaDTO usu : grupo.getEmpleados()) {
                                                String apenom = (safe(usu.getApellido()) + " " + safe(usu.getNombre()))
                                                                .trim();
                                                ...
                                                for (RegistroAsistenciaDTO t : usu.getTLaborado()) {
                                                        ...
                                                        // Cálculos (replica TS)
                                                        String entradaHorario = hora(horaDe(t.getEntrada() != null
                                                                        ? t.getEntrada().getFecha_hora_horario()
                                                                        : null));
                                                        String salidaHorario = hora(horaDe(t.getSalida() != null
                                                                        ? t.getSalida().getFecha_hora_horario()
                                                                        : null));
                                                        String iniAliHorario = "EAS".equals(safe(t.getTipo()))
                                                                        ? hora(horaDe(t.getInicioAlimentacion() != null
                                                                                        ? t.getInicioAlimentacion()
                                                                                                        .getFecha_hora_horario()
                                                                                        : null))
                                                                        : "";
                                                        String finAliHorario = "EAS".equals(safe(t.getTipo()))
                                                                        ? hora(horaDe(t.getFinAlimentacion() != null ? t
                                                                                        .getFinAlimentacion()
                                                                                        .getFecha_hora_horario()
                                                                                        : null))
                                                                        : "";
                                                        ...
                                                        String entrada = timbreValor(
                                                                        t.getEntrada() != null ? t.getEntrada()
                                                        ...
                                                        String tiempoAlimentacion = convertirMinutosATiempo(
                                                                        t.getMinAlimentacion());
                                                        Double minsLaborados = control ? t.getMinLaborados()
                                                                        : t.getMinPlanificados();
                                                        String tiempoLaborado = convertirMinutosATiempo(minsLaborados);

                                                        String tiempoAtraso = convertirMinutosATiempo(
                                                                        t.getMinAtrasos());
                                                        String tiempoSalidaAnt = convertirMinutosATiempo(
                                                                        t.getMinSalidasAnticipadas());

                                                        // Escritura de fila
                                                        UtilExcel.establecerValor(r, col++, item++, null);
                                                        UtilExcel.establecerTexto(r, col++,
                                                                        safe(usu.getIdentificacion()), null);
                                                        UtilExcel.establecerTexto(r, col++, safe(usu.getCodigo()),
                                                                        null);
                                                        UtilExcel.establecerTexto(r, col++, apenom, null);
                                                        UtilExcel.establecerTexto(r, col++, safe(usu.getCiudad()),
                                                                        null);
                                                        UtilExcel.establecerTexto(r, col++, safe(usu.getSucursal()),
                                                                        null);
                                                        UtilExcel.establecerTexto(r, col++, safe(usu.getRegimen()),
                                                                        null);
                                                        UtilExcel.establecerTexto(r, col++, safe(usu.getDepartamento()),
                                                                        null);
                                                        UtilExcel.establecerTexto(r, col++, safe(usu.getCargo()), null);

                                                        UtilExcel.establecerTexto(r, col++,
                                                                        safe(t.getEntrada() != null ? t.getEntrada()
                                                                                        .getFecha_hora_horario()
                                                                                        : null),
                                                                        null); // FECHA (ISO completa)
                        ...
                        // Header centrado
                        UtilExcel.aplicarEstiloARegion(hoja, filaEnc, filaEnc, 0, headers.length - 1, estiloCentroBorde,
                                        true);

    ...
    public byte[] generarReporteVacunasPDF(ReporteVacunasRequest request) {
        try {
            ...
            for (int i = 0; i < lista.size(); i++) {
                ...
                tabla.addCell(ReporteUtil.crearCelda(String.valueOf(v.getId()), ReporteUtil.fuenteTexto(), bgColor));
                tabla.addCell(ReporteUtil.crearCelda(v.getNombre(), ReporteUtil.fuenteTexto(), bgColor));
            }

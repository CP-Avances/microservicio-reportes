...
public class ReporteTimbresVirtualesMovilService {
    ...
    public byte[] generarReporteXLSX(ReporteTimbresVirtualesMovilRequest request) {
        try (XSSFWorkbook libro = new XSSFWorkbook();
            ...
            XSSFSheet hoja = libro.createSheet("Timbres Virtuales Movil");
            ...
            UtilExcel.establecerTexto(hoja, 1, 1, "LISTA DE TIMBRES VIRTUALES MOVIL", estiloTitulo);
            ...
            int[] anchosSinDisp = new int[] { 10, 20, 20, 22, 18, 18, 18, 20, 18, 20, 16, 16, 18, 26, 16, 16 };
            ...
            int[] anchosConDisp = new int[] { 10, 20, 20, 22, 18, 18, 18, 20, 18, 20, 16, 16, 18, 26, 16, 16, 20, 20 };
                ...
                for (GrupoTimbresDTO grupo : request.getData_pdf()) {
                    ...
                    for (EmpleadoTimbreDTO usu : grupo.getEmpleados()) {
                        ...
                        if (usu.getTimbres() == null || usu.getTimbres().isEmpty()) {
                            ...
                            UtilExcel.establecerTexto(r, c++, "", null); // observacion
            ...
            String tableName = "TimbresMovilReporteTabla";
            if (ultimaFila >= filaDatosInicio) {
